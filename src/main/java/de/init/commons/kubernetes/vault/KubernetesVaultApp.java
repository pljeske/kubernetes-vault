...
import de.init.commons.kubernetes.vault.controller.VaultSecretEventHandler;
...
public class KubernetesVaultApp implements CommandLineRunner {
  public static final int RESYNC_PERIOD = 1000; // 1 second
...
//    operator.register(vaultSecretController);
    ...
    SharedIndexInformer<VaultSecret> vaultSecretSharedIndexInformer = informerFactory
            .sharedIndexInformerForCustomResource(VaultSecret.class, RESYNC_PERIOD);
    vaultSecretSharedIndexInformer.addEventHandler(new VaultSecretEventHandler(client, vault, resourceCreatorService));
